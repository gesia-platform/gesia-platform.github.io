    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        function init(){
            ...
            window.onload = setTimeout(function() {scrollToAnchor()}, 1500);;
        }
        ...
        */
        function getDestinationPosition(dest, element){
          ...
          // this line changed based on https://github.com/alvarotrigo/fullPage.js/issues/1854
        if(element.outerHeight() > windowsHeight && options.autoScrolling){
          ...
          // changed for scrolling based on https://github.com/alvarotrigo/fullPage.js/issues/1854
       else if(isScrollingDown && options.autoScrolling){                //The bottom of the destination will be at the bottom of the viewport
                position = sectionBottom;
            }
